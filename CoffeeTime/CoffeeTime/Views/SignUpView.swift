...
final class SignUpView: UIView {
    private let signUpViewTitle: UILabel = {
        let label = UILabel()
    ...
    private func addConstraints() {
        signUpViewTitle.snp.makeConstraints { make in
            make.top.equalTo(10)
            make.centerX.equalToSuperview()
        }
        
        enterEmailField.snp.makeConstraints { make in
            make.top.equalTo(signUpViewTitle.snp.bottom).offset(100)
            make.centerX.equalToSuperview()
